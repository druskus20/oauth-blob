...
debug:
  ...
  wasm-opt -Oz target/wasm32-unknown-unknown/debug/oauth_blob.wasm -o target/debug/oauth_blob_optimized.wasm
...
release: 
  ...
  wasm-opt -Oz target/wasm32-unknown-unknown/release/oauth_blob.wasm -o target/release/oauth_blob_optimized.wasm
